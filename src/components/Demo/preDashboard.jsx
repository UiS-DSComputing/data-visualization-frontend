      ...
      <div style={{ display: "flex" }}>
        <div className="az-content-left az-content-left-components">
          <div style={{ textAlign: "center", fontWeight: "bold" }}>
            {rigSelected ? `${rigSelected.name}'s Files` : "File list"}{" "}
          </div>
          <hr />
          {rigSelected ? (
            allFiles.map((file) => {
              return (
                <>
                  <div
                    key={file.id}
                    className="inputGroup check-input"
                    style={
                      file.uploaded_by.id.toString() === user_id
                  ...
                  >
                    ...
                    />
                    <label className="file-list-label" htmlFor={file.id}>
                      {file.filename}
                    </label>
                  </div>
                </>
        ...
        <div style={{ height: "90vh", width: "100%", overflow: "scroll" }}>
          {selectedFiles.length ? (
            ...
            <MapContainer
              ...
              center={[61.76142272557969, 7.995615188312023]}
              zoom={5}
